...
# Title: Top Block
# Generated: Tue Jun 30 20:30:39 2015
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0_0_0 = uhd.usrp_source(
        	device_addr="addr=192.168.1.200",
        ...
        self.uhd_usrp_source_0_0_0.set_center_freq(samp_freq, 0)
        self.uhd_usrp_source_0_0_0.set_gain(0, 0)
        ...
        self.blocks_file_sink_1_0 = blocks.file_sink(gr.sizeof_gr_complex*1, "drive_test_200.raw", False)
        self.blocks_file_sink_1_0.set_unbuffered(False)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_gr_complex*1, "drive_test_202.raw", False)
        self.blocks_file_sink_1.set_unbuffered(False)
        self.band_pass_filter_0_0 = filter.fir_filter_ccc(1, firdes.complex_band_pass(
        	1, samp_rate, 15E3, 25E3, 1e3, firdes.WIN_HAMMING, 6.76))
        self.band_pass_filter_0 = filter.fir_filter_ccc(1, firdes.complex_band_pass(
        	1, samp_rate, 15E3, 25E3, 1e3, firdes.WIN_HAMMING, 6.76))
        self.analog_sig_source_x_1_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, -20000, 1, 0)
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.blocks_file_sink_1_0, 0))
        self.connect((self.analog_sig_source_x_1_0, 0), (self.blocks_multiply_xx_0_0, 1))
        self.connect((self.uhd_usrp_source_0_0_0, 0), (self.band_pass_filter_0_0, 0))
...
# QT sink close method reimplementation
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.complex_band_pass(1, self.samp_rate, 15E3, 25E3, 1e3, firdes.WIN_HAMMING, 6.76))
        self.uhd_usrp_source_0_0.set_samp_rate(self.samp_rate)
        self.analog_sig_source_x_1.set_sampling_freq(self.samp_rate)
        self.analog_sig_source_x_1_0.set_sampling_freq(self.samp_rate)
        self.band_pass_filter_0_0.set_taps(firdes.complex_band_pass(1, self.samp_rate, 15E3, 25E3, 1e3, firdes.WIN_HAMMING, 6.76))
    ...
    def set_samp_freq(self, samp_freq):
        ...
        self.uhd_usrp_source_0_0_0.set_center_freq(self.samp_freq, 0)
