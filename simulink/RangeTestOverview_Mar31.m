...
Freq_BER_single_antenna = 1-sum(my_cpm_demod_offline(freq_aligned_data(:,1),srate,100,patternvec,1) == expected_data)/length(expected_data);
Freq_BER_single_antenna = Freq_BER_single_antenna + 1-sum(my_cpm_demod_offline(freq_aligned_data(:,2),srate,100,patternvec,1) == expected_data)/length(expected_data);
Freq_BER_single_antenna = Freq_BER_single_antenna + 1-sum(my_cpm_demod_offline(freq_aligned_data(:,3),srate,100,patternvec,1) == expected_data)/length(expected_data);
...
Time_BER_single_antenna = 1-sum(my_cpm_demod_offline(time_aligned_data(:,1),srate,100,patternvec,1) == expected_data)/length(expected_data);
Time_BER_single_antenna = Time_BER_single_antenna + 1-sum(my_cpm_demod_offline(time_aligned_data(:,2),srate,100,patternvec,1) == expected_data)/length(expected_data);
Time_BER_single_antenna = Time_BER_single_antenna + 1-sum(my_cpm_demod_offline(time_aligned_data(:,3),srate,100,patternvec,1) == expected_data)/length(expected_data);
