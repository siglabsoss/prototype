...
%matrix version
%aligned_data = xxcorrelator_single(rnoisydata,srate,clock_comb,detect_threshold);

%single version
aligned_data = [];
for k=1:1:size(rnoisydata,2)
    aligned_data_single = xxcorrelator_single(rnoisydata(:,k),srate,clock_comb,detect_threshold);
